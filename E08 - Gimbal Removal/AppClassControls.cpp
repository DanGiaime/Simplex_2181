...
#pragma endregion
	...
	{
		if (fMultiplier)
			m_qOrientation = m_qOrientation * glm::angleAxis(-.1f, vector3(1.0f, 0.0f, 0.0f));
		else
			m_qOrientation = m_qOrientation * glm::angleAxis(.1f, vector3(1.0f, 0.0f, 0.0f));
	}
	...
	{
		if (fMultiplier)
			m_qOrientation = m_qOrientation * glm::angleAxis(-.1f, vector3(0.0f, 1.0f, 0.0f));
		else
			m_qOrientation = m_qOrientation * glm::angleAxis(.1f, vector3(0.0f, 1.0f, 0.0f));
	}
	...
	{
		if (fMultiplier)
			m_qOrientation = m_qOrientation * glm::angleAxis(-.1f, vector3(0.0f, 0.0f, 1.0f));
		else
			m_qOrientation = m_qOrientation * glm::angleAxis(.1f, vector3(0.0f, 0.0f, 1.0f));
	}
